...
import com.vharia.bookmarker_api.domain.BookmarksRepository;
...
class BookmarkControllerTest {
    ...
    void setUp(){
        ...
        bookmarksRepository.saveAll(bookmarks);
    }
    ...
    void testGetBookmarks(int pageNo, boolean isFirst, boolean isLast, boolean hasNext, boolean hasPrevious) throws Exception {
        int totalPages = 2;
        ...
        mvc.perform(MockMvcRequestBuilders.get("/api/bookmarks?page="+pageNo))
                ...
                .andExpect(jsonPath("$.currentPage").value(pageNo))
    ...
    void shouldCreateBookmarkSuccessfully() throws Exception {
        this.mvc.perform(post("/api/bookmarks")
                ...
                .andExpect(jsonPath("$.title").value("SivaLabs Blog"))
                .andExpect(jsonPath("$.url").value("https://sivalabs.in"));
    }
